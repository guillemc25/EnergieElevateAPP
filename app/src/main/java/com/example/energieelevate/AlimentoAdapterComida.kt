...
class AlimentoAdapterComida(context: Context, private val alimentoList: List<Alimento>) :
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        holder.actionButton?.setOnClickListener {
            ...
            val sharedPreferences2 = context.getSharedPreferences("AlimentosComida", Context.MODE_PRIVATE)
