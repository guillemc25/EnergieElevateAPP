...
class AlimentoAdapterDesayuno(context: Context, private val alimentoList: List<Alimento>) :
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        holder.actionButton?.setOnClickListener {
            ...
            val sharedPreferences = context.getSharedPreferences("CaloriasDesayuno", Context.MODE_PRIVATE)
            val editor = sharedPreferences.edit()
            editor.putInt("sumaCaloriasDesayuno", sumaCalorias)
            editor.apply()

            // Guardar la cadena concatenada en SharedPreferences
            val sharedPreferences2 = context.getSharedPreferences("AlimentosDesayuno", Context.MODE_PRIVATE)
